...
import { diseaseTypesSearch, diseaseTypesDelete } from "../../../../api/urls";
...
export default function DiseaseTypesList() {
   const navigate = useNavigate();
   const [searchKey, setSearchKey] = useState("");
   const [filterStatus, setFilterStatus] = useState("");
   const [isDeleteOpen, setIsDeleteOpen] = useState(false);
   const [deleteId, setDeleteId] = useState<number | null>(null);
   const [data, setData] = useState<DiseaseType[]>([]);
   ...
   return (
      ...
      >
         ...
         <AlertDialog
            title="Are you sure you want to delete this disease type?"
            type="error"
            open={isDeleteOpen}
